...
var BottomNavigation = function (_a) {
    ...
    var _c = (0, react_1.useState)(selected), current = _c[0], setCurrent = _c[1];
    ...
    var navItems = items.map(function (item, idx) {
        return ((0, jsx_runtime_1.jsx)(BottomNavigationItem_1.BottomNavigationItem, { current: current, item: item, id: idx, getItemStyle: getItemStyle, onClick: handleItemClick }, "bottom-nav-item-".concat(idx)));
    });
    return (0, jsx_runtime_1.jsx)("div", __assign({ className: "bottom-nav" }, { children: navItems }));
};
